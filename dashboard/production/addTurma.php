            ...
            <div class="page-title">
              <div class="title_left">
                <h3>Nova Turma</h3>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left " method="POST" action="cadastroTurma.php">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nome da Turma <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="nome_turma" name="nome_turma" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
